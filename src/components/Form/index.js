...
import {GlobalStyle, StyledFormWrapper,RegisterHeading,RegisterInfo, StyledForm, StyledInput, StyledFieldSet, StyledTextArea, StyledError, StyledButton, FullContainer, Column1, Column2, Img, SelectOptions} from './FormElements'
...
const Form = () => {
    return (
        ...
        <Column2>
        <Img src={require('../Images/BlueRect.svg').default} alt="Rectangle" />
        </Column2>
        </FullContainer>
        </>
    )
